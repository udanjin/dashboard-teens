    ...
    <Card
      ...
      title={
        <div className="flex items-center gap-2 flex-1 min-w-0">
          <div className="p-2 bg-purple-50 text-purple-600 rounded-lg text-base flex-shrink-0">
            <BellOutlined />
          </div>
          <div className="flex-1 min-w-0 whitespace-normal">
            <span className="font-semibold text-gray-800 text-base leading-tight block">Action Center</span>
            <p className="text-xs font-normal text-gray-400 m-0 mt-0.5 leading-tight">Verifications & tasks</p>
          </div>
        </div>
      }
      extra={
        totalAlerts > 0 ? (
          <Tag color="error" className="rounded-full px-2 font-semibold flex-shrink-0">
            {totalAlerts} {totalAlerts === 1 ? 'Action' : 'Actions'}
          </Tag>
        ) : (
